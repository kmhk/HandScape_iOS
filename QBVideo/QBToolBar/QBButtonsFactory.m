...
+ (QBButton *)videoEnable {
    ...
    button.iconView = [self iconViewWithNormalImage:@"camera-on-vc.png"
                                      selectedImage:@"cam_off_top_ic"];
    return button;
}
...
+ (QBButton *)auidoEnable {
    ...
    button.iconView = [self iconViewWithNormalImage:@"mute-ic"
...
+ (QBButton *)dynamicEnable {
    ...
    button.iconView = [self iconViewWithNormalImage:@"dynamic-off-ic"
                                      selectedImage:@"sound_off"];
    return button;
}
...
+ (QBButton *)screenShare {
    ...
    button.iconView = [self iconViewWithNormalImage:@"sharescreen-vc"
                                      selectedImage:@"sharescreen-vc"];
    return button;
}
...
+ (QBButton *)answer {
    ...
    button.iconView = [self iconViewWithNormalImage:@"answer-ic"
                                      selectedImage:@"answer-ic"];
    return button;
}
...
+ (QBButton *)decline {
    ...
    button.iconView = [self iconViewWithNormalImage:@"decline-vc"
                                      selectedImage:@"decline-vc"];
    return button;
}
